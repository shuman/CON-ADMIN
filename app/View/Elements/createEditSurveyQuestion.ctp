...
<script type="text/javascript">
	...
	function deleteEditSurQues() {
		$('.delate_s_s_q_e').click(function(){
	...
	$('.createQuestionButton').click(function(){
			    ...
			    $.ajax({
			           ...
			           success: function(data)
			           {
			           		...
			           		$('#surveyQuesDrag').append('<li id="Question_'+data+'" class="ui-sortable-handle"><div class="list_row dot_bg"><span class="wdt_90 esurQues" dataqid='+data+'><div class="srv_qus"><span class="sl slsq">1</span><p>'+question+'</p></div></span><a href="javascript:;"  dataqid='+data+' class="fa fa-trash-o delate_s_s_q_e"><i aria-hidden="true"></i></a><input type="hidden" name="questions[]" value='+data+'></div></li>').fadeIn('slow');
			           		deleteEditSurQues();
